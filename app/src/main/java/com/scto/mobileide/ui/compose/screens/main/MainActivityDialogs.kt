...
import com.scto.mobileide.plugin.ResolvedPluginApkExport
...
import com.scto.mobileide.ui.apk.ApkExportRuntimeLibrariesResolver
import com.scto.mobileide.ui.apk.ApkExportTemplateOption
import com.scto.mobileide.ui.apk.TerminalApkExportResolver
import com.scto.mobileide.ui.compose.components.ApkPackageDialog
import com.scto.mobileide.ui.compose.components.CodeActionsMenu
import com.scto.mobileide.ui.compose.components.CreateFolderDialog
import com.scto.mobileide.ui.compose.components.DeleteConfirmDialog
import com.scto.mobileide.ui.compose.components.FileTreeState
import com.scto.mobileide.ui.compose.components.GoToLineDialog
import com.scto.mobileide.ui.compose.components.LocationListDialog
import com.scto.mobileide.ui.compose.components.LspRenameDialog
import com.scto.mobileide.ui.compose.components.NewFileDialog
import com.scto.mobileide.ui.compose.components.RenameDialog
import com.scto.mobileide.ui.compose.components.ReplaceDialog
import com.scto.mobileide.ui.compose.components.RunConfigDialog
...
import com.scto.mobileide.ui.compose.components.UnsavedChangesOnExitDialog
...
internal fun MainActivityCloseProjectDialog(
    ...
    MobileAlertDialog(
        ...
        title = { MobileDialogTitleText(stringResource(Strings.dialog_close_project_title)) },
        text = {
...
internal fun MainActivityApkPackageDialog(
    ...
    val pluginLogManager = remember(context) {
        com.scto.mobileide.plugin.PluginLogManager.getInstance(context.applicationContext)
    }
    ...
    LaunchedEffect(
        ...
        pluginLogManager.info(
            com.scto.mobileide.plugin.PluginHostLogSources.MainUi,

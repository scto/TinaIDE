...
description: MobileIDE feature:ai 工具、渠道、BYOK、流式响应和停止生成开发指南。用于新增/修改 AI 工具、工具参数、危险操作确认、工具 i18n、渠道配置、API key 存储、streaming 或 AI 与编辑器/文件系统集成。
---
...
- `feature/ai/src/main/java/com/scto/mobileide/ai/di/AiModule.kt`。
- `feature/ai/src/main/java/com/scto/mobileide/ai/viewmodel/AiChatViewModel.kt`。
- `feature/ai/src/main/java/com/scto/mobileide/ai/tools/AiTool.kt`。
...
- `feature/ai/src/main/java/com/scto/mobileide/ai/tools/ToolParameterParser.kt`。
- `feature/ai/src/main/java/com/scto/mobileide/ai/tools/ToolI18n.kt`。
- `feature/ai/src/main/java/com/scto/mobileide/ai/repository/ConversationRepository.kt`。
- `feature/ai/src/main/java/com/scto/mobileide/ai/channel/AiChannelRepository.kt`。
- `feature/ai/src/main/java/com/scto/mobileide/ai/channel/AiChannelApiKeyStore.kt`。
- `feature/ai/src/main/java/com/scto/mobileide/ai/api/AiApiClient.kt`。
- `feature/ai/src/main/java/com/scto/mobileide/ai/stream/ChatStreamController.kt`。
- `app/src/main/java/com/scto/mobileide/ai/integration/AiToolsIntegrationManager.kt`。
...
- `CUSTOM_BYOK` 是开源客户端实际可用路径；不要假设 `MOBILE_GATEWAY` 已可直接构建客户端。

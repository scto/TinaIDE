...
- `core/designsystem/src/main/java/com/scto/mobileide/ui/theme/MobileIDETheme.kt`。
- `core/i18n/src/main/java/com/scto/mobileide/core/i18n/AppStrings.kt`。
- `core/i18n/src/main/java/com/scto/mobileide/core/i18n/ResExt.kt`。
- `core/i18n/src/main/java/com/scto/mobileide/core/i18n/TextResourceAliases.kt`。
...
- `app/src/main/java/com/scto/mobileide/ui/compose/screens/main/MainScreen.kt`。
- `app/src/main/java/com/scto/mobileide/ui/compose/screens/main/MainActivityScreenHost.kt`。
- `feature/settings/src/main/java/com/scto/mobileide/ui/compose/screens/settings/SettingsScreen.kt`。
- `app/src/main/java/com/scto/mobileide/settings/SettingsActivity.kt`。

## UI 约定

- Activity `setContent` 应包 `MobileIDETheme`。
- 优先复用 `core/designsystem` 和已有 `Mobile*` 组件，不要重复造按钮、弹窗、底栏样式。
...
- 不要绕过 `MobileIDETheme`。
- 不要新增只在一个页面使用的重复设计组件，先复用已有 `Mobile*` 组件。

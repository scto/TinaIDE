 ...
 */
class MobileAndroidAppVersioningPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        with(target) {
            val versionPropsFile = rootProject.file("version.properties")

            val autoIncrementReleaseVersionEnabled =
                resolveBooleanGradleProperty("mobile.autoIncrementReleaseVersion", default = true)
            ...
            val versioningExtension = MobileAppVersioningExtension(versionPropsFile, effectiveVersion)
            extensions.add("mobileAppVersioning", versioningExtension)
            ...
            pluginManager.withPlugin("com.android.application") {
                extensions.configure<ApplicationExtension> {
                    defaultConfig {
                        ...
                        manifestPlaceholders["MOBILE_BASE_VERSION_CODE"] =

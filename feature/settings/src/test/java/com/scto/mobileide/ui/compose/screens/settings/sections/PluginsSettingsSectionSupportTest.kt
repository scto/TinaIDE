...
import com.scto.mobileide.plugin.PluginConfiguration
import com.scto.mobileide.plugin.PluginConfigurationProperty
import com.scto.mobileide.plugin.PluginContributions
...
import com.scto.mobileide.plugin.PluginDiagnosticsSnapshot
import com.scto.mobileide.plugin.PluginLogLevel
import com.scto.mobileide.plugin.PluginManifest
import com.scto.mobileide.plugin.PluginMenuItem
import com.scto.mobileide.plugin.PluginMenus
import com.scto.mobileide.plugin.PluginRequirements
import com.scto.mobileide.plugin.PluginToolchainRequirements
    ...
    fun installFileAndLspStatusHelpers_shouldNormalizeInputs() {
        assertThat(
            PluginsSettingsSectionSupport.resolveInstallSourceFileName(
                "content://plugins/foo/bar/demo.mobileplug"
            )
        ).isEqualTo("demo.mobileplug")
        assertThat(
            PluginsSettingsSectionSupport.resolveInstallSourceFileName(
                "C:\\Users\\demo\\plugin package.mobileplug"
            )
        ).isEqualTo("plugin_package.mobileplug")
        assertThat(
            PluginsSettingsSectionSupport.resolveInstallSourceFileName(
                "C:/Users/demo/plugin:package.mobileplug"
            )
        ...
        assertThat(
            PluginsSettingsSectionSupport.buildTempInstallFileName(
                ...
                fileName = "demo.mobileplug",
            )
        ).isEqualTo("install_123_demo.mobileplug")
        assertThat(

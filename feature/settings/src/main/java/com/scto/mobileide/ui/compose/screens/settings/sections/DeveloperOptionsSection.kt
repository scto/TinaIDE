...
internal fun DeveloperOptionsSection(
    ...
    val serverConfig = remember { MobileServerConfig.getInstance(context) }
    ...
    if (showServerUrlDialog) {
        ...
        MobileAlertDialog(
            ...
            title = { MobileDialogTitleText(stringResource(Strings.dialog_title_mobile_server_url)) },
            text = {
                MobileDialogContentColumn {
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(Strings.label_mobile_server_url)) },
                        singleLine = true,
                    )
                    serverUrlStatusText?.let {
                        MobileDialogMessageCard(message = it)
                    }
                }
            },
            confirmButton = {
    ...
    SettingsCard {
        SettingsMenuItemWithIcon(
            ...
            title = stringResource(Strings.dev_options_mobile_server_url),
            subtitle = stringResource(Strings.dev_options_mobile_server_url_desc),
    ...
    if (showServerConfigDialog) {
        val configPreview = remember(showServerConfigDialog) {
            DeveloperOptionsSectionSupport.resolveServerConfigPreview(
                com.scto.mobileide.core.config.ServerConfigManager.getCurrentConfig()
            )
        }
        ...
        MobileAlertDialog(
            ...
            title = { MobileDialogTitleText(stringResource(Strings.dev_options_server_config_title)) },
            text = {
                MobileDialogContentColumn(
                    modifier = Modifier

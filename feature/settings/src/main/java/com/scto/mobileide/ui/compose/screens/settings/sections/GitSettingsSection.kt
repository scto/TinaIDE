...
import com.scto.mobileide.core.git.AndroidGitCredentialManager
...
private fun GitSshContent() {
    ...
    if (generateDialogVisible) {
        MobileAlertDialog(
            ...
            title = { MobileDialogTitleText(stringResource(Strings.git_ssh_generate_dialog_title)) },
            text = {
                MobileDialogContentColumn {
                    MobileTextField(
                        value = generateName,
            ...
            dismissButton = {
                MobileTextButton(text = stringResource(Strings.btn_cancel), onClick = { generateDialogVisible = false })
            }
        )
    }
    ...
    if (importDialogVisible) {
        MobileAlertDialog(
            ...
            title = { MobileDialogTitleText(stringResource(Strings.git_ssh_import_dialog_title)) },
            text = {
                MobileDialogContentColumn {
                    MobileTextField(
                        value = importName,

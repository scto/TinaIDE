package com.scto.mobileide.ai.viewmodel

import android.content.Context
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.scto.mobileide.ai.api.*
import com.scto.mobileide.ai.channel.AiChannelRepository
import com.scto.mobileide.ai.config.AiPreferences
import com.scto.mobileide.ai.model.*
import com.scto.mobileide.ai.repository.ConversationMeta
import com.scto.mobileide.ai.repository.ConversationRepository
import com.scto.mobileide.ai.retry.RetryCoordinator
import com.scto.mobileide.ai.retry.RetryPolicy
import com.scto.mobileide.ai.stream.ChatStreamController
import com.scto.mobileide.ai.tools.ToolExecutionContext
import com.scto.mobileide.ai.tools.ToolExecutionCoordinator
import com.scto.mobileide.ai.tools.ToolExecutionResult
import com.scto.mobileide.ai.tools.executor.ContextDataProvider
import com.scto.mobileide.ai.tools.executor.DiagnosticsCallbacksProvider
import com.scto.mobileide.ai.tools.executor.ExecutionCallbacksProvider
import com.scto.mobileide.ai.tools.executor.ProjectInfoProvider
import com.scto.mobileide.ai.tools.executor.ToolCallbacksFactory
...
class AiChatViewModel(
     ...
     */
    fun setFileSystemCallbacks(fileSystemCallbacks: com.scto.mobileide.ai.tools.executor.filesystem.FileSystemCallbacks) {
        val provider = object : ContextDataProvider {
            override fun provideData(): Map<String, Any> = buildMap {
     ...
     */
    fun setCodeAnalysisCallbacks(codeAnalysisCallbacks: com.scto.mobileide.ai.tools.executor.code.CodeAnalysisCallbacks) {
        val provider = object : ContextDataProvider {
            override fun provideData(): Map<String, Any> = buildMap {
    ...
    private suspend fun buildApiClient(config: AiConfig): AiApiClient? {
        return when (config.accessMode) {
            AiAccessMode.MOBILE_GATEWAY -> null
    ...
    private suspend fun resolveApiClientBlockerMessage(cfg: AiConfig?): String = when (cfg?.accessMode) {
        AiAccessMode.MOBILE_GATEWAY -> context.getString(R.string.ai_error_gateway_unavailable)

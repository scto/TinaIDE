...
import com.scto.mobileide.core.network.ApiEnvelopeParseResult
...
import com.scto.mobileide.core.security.ServerConfigHmacVerifier
...
class MobileServerApi private constructor(
    ...
    companion object {
        ...
        fun getInstance(
            ...
            return instance ?: synchronized(this) {
                instance ?: MobileServerApi(baseUrl.trimEnd('/'), client).also { instance = it }
            }
        }
    ...
    suspend fun getServerConfig(): ApiResult<ServerConfigResponse> = withContext(Dispatchers.IO) {
        try {
            ...
            return@withContext runCatching {
                ...
                val secret = MobileServerEnvironment.serverConfigHmacSecret
